...
gens = c("wt","wt","wt","wt","wt","wt","wt","wt","wt","wt","pwd","gwd","bam1","bam2","amy3-bam1","rb5","rb22","kin10","bzip63-1","sweet1112","prr7","prr7prr9","ztl3")
bats = c(    1,  2,   3,   4,   5,   6,   7,   9,  12,  13,    1,    1,     3,     3,          9,    2,    12,      4,         7,          5,     4,        13,    13)  
