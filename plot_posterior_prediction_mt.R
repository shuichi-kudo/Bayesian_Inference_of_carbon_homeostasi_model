...
for(gen in gens){
  ...
  for(pho in 1:2){
    for(met in 1:3){
      ...
      sim_result_wt = read.csv(paste("result/simulation/simulation_",bat,"_","wt",".csv",sep=""))
      ...
      sim_result_mt = read.csv(paste("result/simulation/simulation_",bat,"_",gen,".csv",sep=""))
